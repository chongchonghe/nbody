...
Python is too slow for this job, so I use C code calenergy.c to do the heavy job
@author: chongchonghe
"""
...
"""
dPath = "../simulations/cluster03_small_epsilon"
...
N = 1000
dPath = "../simulations/cluster03_BH"
...
plt.plot(indices, energy3, label="BH-nbody")
plt.xlabel("steps")
plt.ylabel("total energy")
plt.legend()
plt.tight_layout()
